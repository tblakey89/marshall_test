ActiveAdmin.register_page "Dashboard" do
  ...
  ActiveAdmin::Dashboards.build do
    section "Dealership Scores" do
      table_for Dealership.find(:all, select: "dealerships.id, dealerships.name, avg(users.score) as average_score, avg(users.time_taken) as average_time", limit: 10, joins: :users, order: 'average_score') do |t|
